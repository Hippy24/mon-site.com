...
const translations = {
  fr: {
    ...
    "exp-title-0": "Stage Data Scientist en santé",
    "exp-intro-0": "Dans le cadre de mon stage de Master 1, je contribue au développement de solutions d’exploitation de données textuelles de santé, en mobilisant des approches de traitement automatique du langage naturel pour répondre à des besoins concrets d’analyse, d’évaluation et d’aide à la décision.",
    "exp-subtitle-0a": "Missions principales",
    "exp-subtitle-0b": "Analyse et valorisation",
    "exp-li-0a": "Développement de solutions NLP pour l’exploitation de données textuelles de santé issues de l’EDS.",
    "exp-li-0b": "Conception et expérimentation de modèles autour de la reconnaissance d’entités nommées, de l’interrogation en langage naturel et de prototypes applicatifs.",
    "exp-li-0c": "Analyse, évaluation et intégration des solutions développées en réponse aux besoins utilisateurs.",
    "exp-li-0d": "Production de statistiques, reporting et valorisation des résultats dans une logique d’aide à la décision.",
    "exp-path-title-0": "Environnement technique",
    "exp-path-0": "NLP",
    "exp-path-0b": "Données textuelles de santé",
    "exp-path-0c": "NER",
    "exp-path-0d": "Interrogation en langage naturel",
    "exp-path-0e": "Prototypage",
    "exp-path-0f": "Statistiques & reporting",
  ...
  en: {
    ...
    "exp-title-0": "Health Data Scientist Internship",
    "exp-intro-0": "As part of my Master’s Year 1 internship, I contribute to the development of solutions for exploiting textual health data by using natural language processing approaches to address practical needs in analysis, evaluation and decision support.",
    "exp-subtitle-0a": "Main responsibilities",
    "exp-subtitle-0b": "Analysis and delivery",
    "exp-li-0a": "Development of NLP solutions for exploiting textual health data from the health data warehouse.",
    "exp-li-0b": "Design and experimentation of models involving named entity recognition, natural language querying and application prototypes.",
    "exp-li-0c": "Analysis, evaluation and integration of the developed solutions in response to user needs.",
    "exp-li-0d": "Production of statistics, reporting and delivery of results in a decision-support logic.",
    "exp-path-title-0": "Technical environment",
    "exp-path-0": "NLP",
    "exp-path-0b": "Textual health data",
    "exp-path-0c": "NER",
    "exp-path-0d": "Natural language querying",
    "exp-path-0e": "Prototyping",
    "exp-path-0f": "Statistics & reporting",
